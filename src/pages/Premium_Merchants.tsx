...
import { PermMerchantsTableHeaderData, PremMerchantTableBodyData } from '@/helper/data';

const PermiumMerchants = () => {
    return (
        <DashboardLayout>
            <div>
                <div className="flex flex-col gap-5 md:flex-row md:items-center justify-between mb-8">
                    <div>
                        <h5 className="font-semibold text-xl md:text-2xl leading-tight text-[#0F1729]">Premium Merchants</h5>
                        <h6 className="font-normal text-base md:text-lg leading-tight text-[#161819]">€59 verified dealerships with featured placement</h6>
                    </div>
                        ...
                        <table className="w-full border-collapse">
                            <thead className="sticky -top-[2px] z-10 bg-[#F1F5F9]">
                                <tr className="border border-[#E1E7EF] rounded-t-[10px]">
                                    {PermMerchantsTableHeaderData.map((tabular) => {
                                        return (
                            ...
                            <tbody>
                                {PremMerchantTableBodyData.map((dataRow, index) => (
                                    <tr key={index} className="border border-[#E1E7EF]">
                                        ...
                                        <td className="px-4 py-3 text-[#0F1729] text-sm lg:text-base">
                                            <Badge text={dataRow.statusVerify} variant={dataRow.statusVerifyVariant} className="text-sm" />
                                        </td>
...
export default PermiumMerchants;