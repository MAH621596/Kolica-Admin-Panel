...
import {
    sectionTabsMenu,
    basicInfoIndividual,
    importantLegalEntity,
    basicInfoLegalEntity,
            ...
            <section className="md:px-4 lg:px-0">
                <HeroCard parentClass="!bg-[#F9FAFB] !py-[25px] !px-[30px]">
                    <div className='flex flex-col lg:flex-row items-start gap-[25px]'>
                        <InfoListCard
                            title="Why register as a legal entity?"
                            data={PostNewAdLegalEntityData} />
